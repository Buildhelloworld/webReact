...
import Testing from "./components/Bracketing Method/Testing";
import Test from "./components/Marix/TestM"; 
import Marix from "./components/Marix/TestMarix";
import TestRe from "./components/Regression/TestRe";
  ...
  return (
    <div>
      ...
      <BrowserRouter>
        ...
        <Route path="/Matrix" element={<Marix/>}/>
        <Route path="/gauss" element={<Gauss/>}/>
