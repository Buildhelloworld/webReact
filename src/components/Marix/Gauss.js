        ...
        <Container className="mb-4">
            ...
            <Row className="mb-4">
                    ...
                    <input type="number" id="N" value={N} 
                     onChange={e =>{setN(parseInt(e.target.value));setMatrix(new Array(parseInt(e.target.value)).fill(new Array(parseInt(e.target.value)+1).fill(0)));}} ></input>
                    </Col>
                </Row>
                <Container>
                    {Matrix.map((element,index)=>{
                        ...
                        <Table>
                            <tr key={i}>
                            {Matrix[index].map((e,index)=>{return(<td key={""+i+index}>
                              <h5>{i}{index}</h5>
                              <input id={""+i+index}/></td>)
                                }
                              )
